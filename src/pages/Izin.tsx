        ...
        <div className="flex-1 flex justify-center bg-gray-50 relative z-20 w-full md:w-1/2 h-full border-l border-gray-200">
          <div className="w-full max-w-sm bg-gray-50 h-full flex flex-col relative mx-auto shadow-none md:shadow-[0_0_15px_rgba(0,0,0,0.05)] overflow-hidden">
              ...
              <div className="flex mt-5 bg-white/10 rounded-xl p-1 gap-1 border border-white/5">
                <button
                  ...
                  className={`flex-1 py-2 rounded-lg text-xs font-black transition-all ${
                    showForm ? 'bg-[#fbc02d] text-[#3e2723] shadow-md' : 'text-white/70 hover:text-white hover:bg-white/10'
                  }`}
                >
                  ...
                  <div className="grid grid-cols-2 gap-3">
                    <div>
                      ...
                      <input
                        ...
                        className="w-full bg-white border border-gray-200 rounded-xl py-3 px-4 text-sm font-bold text-[#3e2723] outline-none focus:border-[#fbc02d] focus:ring-2 focus:ring-[#fbc02d]/20 transition-all shadow-sm"
                        required
                      />
                    </div>
                    <div>
            ...
            {!showForm && (
              <div className="flex-1 overflow-y-auto pt-5 px-6 bg-gray-50 no-scrollbar pb-24">
                ...
                <div className="flex justify-between items-center mb-4">
                  ...
                  >
                    <i className={`fa-solid fa-rotate-right text-[10px] text-[#fbc02d] ${isLoadingHistory ? 'fa-spin' : ''}`}></i>
                    Refresh
                  </button>
                </div>
                    ...
                    {leaveHistory.map((item) => (
                      ...
                      >
                        ...
                        <div className="flex items-center justify-between mt-3 bg-gray-50 p-2.5 rounded-xl border border-gray-100">
                          ...
                          {getAttachment(item) && (
                            <i className="fa-regular fa-image text-blue-500 text-xs"></i>
                          )}
                        </div>
                      </button>
                    ))}
            ...
            {selectedRecord && (
              ...
              >
                <div className="bg-white w-full max-w-sm rounded-t-[2.5rem] md:rounded-[2rem] flex flex-col overflow-hidden shadow-2xl animate-zoomIn border border-gray-100">

                  <div className="flex justify-center pt-4 pb-2 md:hidden">
                    <div className="w-12 h-1.5 bg-gray-200 rounded-full"></div>
                  </div>

                  <div className="flex justify-between items-center px-6 py-4 md:py-5 border-b border-gray-50 bg-[#fff8e1]/50">
                    <h3 className="font-black text-[#3e2723] text-lg"><i className="fa-solid fa-file-lines text-[#fbc02d] mr-2"></i>Detail Izin</h3>
                    <button
                      onClick={() => setSelectedRecord(null)}
                      className="w-8 h-8 bg-white border border-gray-200 text-gray-500 rounded-full flex items-center justify-center hover:bg-red-50 hover:text-red-500 hover:border-red-100 transition-colors shadow-sm"
                    >
                    ...
                    <div className={`rounded-2xl px-5 py-4 flex items-center gap-4 shadow-sm ${
                      ...
                      <div className={`w-12 h-12 rounded-full flex items-center justify-center text-xl shadow-sm bg-white ${
                        ...
                        <i className={`fa-solid ${
                          selectedRecord.status?.toLowerCase() === 'approved' ? 'fa-circle-check' :
                          selectedRecord.status?.toLowerCase() === 'rejected' ? 'fa-circle-xmark' :
                          'fa-clock'
                        }`}></i>
                      </div>
                      <div>
                        ...
                        <p className={`text-base font-black leading-none ${
                          selectedRecord.status?.toLowerCase() === 'approved' ? 'text-green-700' :
                          selectedRecord.status?.toLowerCase() === 'rejected' ? 'text-red-700' :
                          'text-yellow-700'
                        }`}>
                    ...
                    <div className="bg-gray-50 rounded-2xl border border-gray-100 p-1">
                      ...
                      {selectedRecord.description && (
                        <div className="flex items-start gap-3 px-4 py-3">
                          ...
                          <div>
                            <p className="text-[9px] text-gray-400 font-bold uppercase tracking-wider mb-0.5">Keterangan / Alasan</p>
            ...
            {previewUrl && (
              ...
              >
                <div className="w-full max-w-2xl flex flex-col gap-4 animate-zoomIn relative">
